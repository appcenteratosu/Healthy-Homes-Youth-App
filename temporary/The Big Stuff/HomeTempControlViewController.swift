...
class HomeTempControlViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if value7 == true {
            bookmarkSelected7.setBackgroundImage(UIImage(named: "checked box"), for: UIControlState.normal)
        } else {
            bookmarkSelected7.setBackgroundImage(UIImage(named: "check list box (unfilled)"), for: UIControlState.normal)
        }
    }
